...
kp_range = seq(-180, -100, by=1)
ki_range = seq(-49, -49, by=1)
the_ki = -49
...
cost_vector = rep(0, length(kp_range))
...
plot(kp_range, cost_vector, col = 'darkblue', lwd = 3, main = "Cost of Laser simulation over the Kp gain factor range")
lines(kp_range, cost_vector, col = 'darkblue', lwd = 3)
