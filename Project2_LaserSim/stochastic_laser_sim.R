...
plot(tt, PV, main = paste("Process Variable over time", type_of_model, sep = " "))
lines(tt, PV)
...
# start_index = floor(length(tt) / 2)
# end_index = floor(length(tt) * (19/20)) 
# plot(tt[start_index:end_index], PV[start_index:end_index], col = 'blue')
# lines(tt[start_index:end_index], PV[start_index:end_index], col = 'blue')
# lines(tt[start_index:end_index], set_points[start_index:end_index], col = 'green')
rm(list = ls())